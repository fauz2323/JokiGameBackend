...
<head>
    ...
    <meta name="author" content="SAFEMETALANDS">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a class="slide-item" href="{{ route('game-index') }}">Game List</a></li>
                                    <li><a class="slide-item" href="{{ route('product-index') }}">Product
                                            List</a></li>
            ...
            <div class="container">
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-md-12 col-sm-12 text-center">
                        Copyright © 2022 <a href="javascript:void(0)">SAFEMETALANDS</a>. Designed with <span
                            class="fa fa-heart text-danger"></span> by <a href="javascript:void(0)">
                            SAFEMETALANDS-TEAM
                        </a> All
                        rights reserved.
                    </div>
